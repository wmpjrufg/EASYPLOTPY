...
<table style = "width:100%">
    ...
    <tr>
        ...
        <td><p align="justify">List of colors for the treemap (key required in plot_setup)</p></td>
        <td>list</td>
    </tr>
    <tr>
        <td><code>labels</code></td>
        <td><p align="justify">List of labels for the treemap (key required in plot_setup)</p></td>
        <td>list</td>
    </tr>
</table>
